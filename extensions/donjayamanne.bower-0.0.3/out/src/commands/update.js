...
function update(adapter, progressIndicator) {
    ...
    bower.commands
        ...
        var packages = installedPackages.map(function (item) { return { label: item, description: (Array.isArray(installed[item]) ? installed[item][0] : installed[item]), name: item, all: false }; });
